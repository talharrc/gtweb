    ...
    <div className="relative pt-32 pb-24">
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="mb-12">
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-white mb-6" style={{ fontFamily: 'Syne, sans-serif' }}>{study.name}</h1>
        ...
        <div className="flex flex-col gap-10">
          <div className="glass-card rounded-2xl p-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-bold text-white" style={{ fontFamily: 'Syne, sans-serif' }}>The Challenge</h2>
            </div>
          ...
          <div className="glass-card rounded-2xl p-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-bold text-white" style={{ fontFamily: 'Syne, sans-serif' }}>The Solution</h2>
            </div>
          ...
          <div className="glass-card rounded-2xl p-8">
            <div className="flex items-center gap-3 mb-5">
              ...
              <h2 className="text-xl font-bold text-white" style={{ fontFamily: 'Syne, sans-serif' }}>Stack & Tools</h2>
            </div>
            <div className="flex flex-wrap gap-2">
          ...
          <div className="glass-card rounded-2xl p-8 border-primary/20">
            <h2 className="text-xl font-bold text-white mb-4" style={{ fontFamily: 'Syne, sans-serif' }}>The Result</h2>
        ...
        <div className="mt-16 text-center glass-card rounded-3xl p-12">
          <h2 className="text-3xl font-bold text-white mb-4" style={{ fontFamily: 'Syne, sans-serif' }}>Work with us</h2>
