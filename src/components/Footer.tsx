...
export default function Footer({ onPageChange }: FooterProps) {
  ...
  return (
    <footer className="relative overflow-hidden" style={{ background: '#030510' }}>
      {/* Glow accent line at top */}
      <div className="absolute top-0 left-0 right-0 h-px" style={{ background: 'linear-gradient(to right, transparent, rgba(0,82,255,0.6) 30%, rgba(0,194,255,0.8) 50%, rgba(0,82,255,0.6) 70%, transparent)', boxShadow: '0 0 20px rgba(0,82,255,0.4)' }} />

      {/* Ambient glow blobs */}
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[700px] h-[350px] rounded-full pointer-events-none" style={{ background: 'radial-gradient(ellipse at center, rgba(0,82,255,0.06) 0%, transparent 70%)' }} />
      <div className="absolute top-1/2 left-0 w-[300px] h-[300px] rounded-full pointer-events-none" style={{ background: 'radial-gradient(ellipse at center, rgba(0,82,255,0.04) 0%, transparent 70%)' }} />
      ...
      <div className="max-w-7xl mx-auto px-6 pt-10 pb-6 relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8 mb-8 pb-8 border-b" style={{ borderColor: 'rgba(255,255,255,0.06)' }}>
          ...
          <div className="flex items-center gap-4">
            <div className="relative">
              <div className="absolute inset-0 rounded-2xl blur-md" style={{ background: 'rgba(0,82,255,0.3)', transform: 'scale(1.2)' }} />
              <div className="relative w-14 h-14 rounded-2xl flex items-center justify-center" style={{ background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(0,82,255,0.2)', backdropFilter: 'blur(12px)' }}>
          ...
          >
            <span className="w-8 h-8 rounded-full flex items-center justify-center group-hover:rotate-45 transition-transform duration-500" style={{ background: 'linear-gradient(135deg,#0052FF,#00C2FF)' }}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-8">
          ...
          {/* Column 1 — About */}
          <div>
            <h5 className="text-[10px] font-mono font-bold tracking-[0.2em] uppercase mb-5" style={{ color: '#0052FF' }}>About</h5>
            ...
            <ul className="space-y-3">
              {SERVICE_LINKS.map(({ label, anchor }) => (
                <li key={anchor}>
                  ...
                  >
                    <span className="w-1.5 h-1.5 rounded-full flex-shrink-0 transition-all group-hover:w-2.5" style={{ background: '#0052FF' }} />
                    {label}
                  </button>
                </li>
              ))}
          ...
          {/* Column 3 — Company */}
          <div>
            <h5 className="text-[10px] font-mono font-bold tracking-[0.2em] uppercase mb-5" style={{ color: '#0052FF' }}>Company</h5>
            <ul className="space-y-3">
              {[
            ...
            <ul className="space-y-4">
              ...
              <li>
                <a href="mailto:mail.galaxatech@gmail.com"
                  ...
                  onMouseLeave={e => { (e.currentTarget as HTMLAnchorElement).style.color = 'rgba(255,255,255,0.45)'; }}
                >
                  <div className="w-8 h-8 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: 'rgba(0,82,255,0.1)', border: '1px solid rgba(0,82,255,0.2)' }}>
                    <Mail className="w-3.5 h-3.5" style={{ color: '#0052FF' }} />
                  </div>
        ...
        <div className="pt-6 border-t" style={{ borderColor: 'rgba(255,255,255,0.06)' }}>
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-4">
            <div className="flex items-center gap-2">
              <Sparkles className="w-3.5 h-3.5" style={{ color: '#0052FF' }} />
