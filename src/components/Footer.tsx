        ...
        <div className="pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs tracking-wide text-white/40">
          ...
          <div className="flex gap-6 font-medium items-center">
            ...
            <button 
              ...
              className="text-[10px] font-mono hover:text-primary transition-colors cursor-pointer text-white/20 select-none uppercase tracking-widest focus:outline-none ml-2 border-l border-white/5 pl-4"
            >
              Admin Panel
            </button>
          </div>
