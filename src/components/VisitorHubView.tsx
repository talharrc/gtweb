      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="mb-12 relative z-10">
          ...
          <p className="text-white/60 text-xs sm:text-base max-w-2xl font-sans">
            Welcome to the Galaxa Visitor's Hub. This is our public vault where we compile approachable research, powerful copy-paste prompts, and active social updates designed to help you leverage artificial agency in daily life.
          </p>
        </div>
