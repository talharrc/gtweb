...
// via the pass), so this hub renders instantly. Real project data, work
// logs, resources etc. can be layered back in later.
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4 sm:px-6 py-10">
      <div className="glass-card max-w-md w-full p-6 sm:p-8 rounded-2xl text-center">
        <div className="w-12 h-12 rounded-xl bg-emerald-500/15 border border-emerald-500/30 flex items-center justify-center mx-auto mb-4 shadow-[0_0_25px_rgba(52,211,153,0.15)]">
          <ShieldCheck className="w-5 h-5 text-emerald-400" />
        </div>

        <h1 className="text-white font-bold text-xl sm:text-2xl mb-1" style={{ fontFamily: 'var(--font-display)' }}>Builder Hub</h1>
        ...
        <p className="text-white/30 text-xs leading-relaxed mb-6">
          Your dashboard is being built out. Check back soon for tasks, work logs, and resources.
        </p>
