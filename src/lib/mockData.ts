...
const INITIAL_PRODUCTS: Product[] = [
  {
    ...
    imageUrl: '', isActive: true, isFeatured: true,
    plans: [
  ...
  },
  {
    ...
    plans: [
      { id: 'plan-combo-1m', label: 'Combo Plan', durationLabel: '1 Month', durationDays: 30, priceBDT: 489 },
    ],
  ...
  },
  {
    ...
    imageUrl: '', isActive: true,
    plans: [
      { id: 'plan-1m', label: 'Standard', durationLabel: '1 Month', durationDays: 30, priceBDT: 249 },
    ],
  ...
  },
  {
    ...
    imageUrl: '', isActive: true,
    plans: [
      { id: 'plan-1y', label: 'Full Year Invite', durationLabel: '1 Year', durationDays: 365, priceBDT: 599 },
    ],
  ...
  },
  {
    ...
    imageUrl: '', isActive: true,
    plans: [
      { id: 'plan-1m', label: 'Standard', durationLabel: '1 Month', durationDays: 30, priceBDT: 299 },
    ],
  ...
  },
  {
    ...
    imageUrl: '', isActive: true,
    plans: [
      { id: 'plan-500', label: '৳500 Balance', durationLabel: 'One-time', durationDays: 0, priceBDT: 550 },
  ...
  },
  {
    ...
    imageUrl: '', isActive: true,
    plans: [
      { id: 'plan-60uc', label: '60 UC', durationLabel: 'One-time', durationDays: 0, priceBDT: 100 },
      { id: 'plan-325uc', label: '325 UC', durationLabel: 'One-time', durationDays: 0, priceBDT: 480 },
    ],
